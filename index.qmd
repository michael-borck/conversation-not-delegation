...
- **Google Gemini (Nano Banana)** — generative AI for creating the comic strip illustrations
- **Python** and **Jupyter Notebooks** — the original medium in which the ideas were developed and tested
