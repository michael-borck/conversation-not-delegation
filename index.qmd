...
Most chapters close with a short practice section. Early chapters provide complete RTCF starting prompts; later chapters increasingly ask you to begin without AI, evaluate evidence, or transfer the method to your own work. RTCF (Role, Task, Context, Format) is covered properly in @sec-rtcf and summarised in @sec-quick-reference. The structure is scaffolding, not a ritual. Use only the elements that clarify your task, then push back on the first answer.
