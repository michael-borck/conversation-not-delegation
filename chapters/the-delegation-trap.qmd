...
Judgement is the everyday name for what philosophers call agency: your capacity to choose, weigh, and stand behind the outcome. To delegate one is to give up the other. The two words name the same thing from different rooms.
...
::: {.callout-warning title="The delegation test"}
...
> **Role:** You are a mentor who has watched capable people quietly deskill themselves, and you are not gentle about it.
>
...
>
> **Format:** Three lists, one line of reasoning against each item. Then name the single task I delegated that I most needed to do myself, and say what I lost by not doing it.
