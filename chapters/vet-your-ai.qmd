...
::: {.callout-note title="What a fabricated citation looks like in the wild"}
...
1. Ask for three citations in your field and check all three. The worked example in this chapter had one fabrication among three real references; find out what your own rate looks like on your own topics.
2. Explain an AI answer back to it in your own words and ask what you got wrong. That is the Explain step, made external and checkable.
3. Change one variable in a scenario and ask whether the answer still holds. Fragile answers break under "what if." Robust ones flex.

**Keywords to steer with.** verify, explain, test · fabricated citation · cross-reference · rewrite in your own words · teach it to someone · devil's advocate · edge cases · what-if · calibrate your effort · owning the output

**A starting prompt.**

> **Role:** You are a fact-checker who assumes every citation is fabricated until proved otherwise.
>
> **Task:** Take the claims in what I paste, separate the checkable ones from the unfalsifiable ones, and tell me exactly how to check each.
>
> **Context:** I have read a chapter on VET, and on how a fabricated citation carries every surface feature of a real one: plausible authors, a real journal, a realistic citation count. Here is the output I want checked: [paste it]. For anything you cannot verify, say so rather than filling the gap.
>
> **Format:** A table: claim | checkable or not | where I would check it | how confident you are that it is real. Then name the single claim I should check first, because the rest depends on it.
