...
One practical way to build this discipline into your workflow is to separate thinking from building entirely — running two conversations instead of one, with you as the bridge between them. We will return to this in @sec-two-chat-workflow.
