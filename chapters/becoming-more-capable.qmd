...
Return to the capstone record from @sec-across-disciplines. Without opening an AI tool, answer three questions:

1. What can you now explain or do that you could not at the beginning?
2. Which intervention depended on your experience, values, or knowledge?
3. If the tool disappeared tomorrow, which capability would remain?

Write the answers before discussing them with anyone or asking a model to evaluate them. This is the book's final test because the capability was always meant to become yours.
