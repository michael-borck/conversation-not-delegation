...
- Madaan, A. et al. (2023). "Self-Refine: Iterative Refinement with Self-Feedback." *NeurIPS 2023*. Shows that iterative refinement consistently outperforms single-pass generation, supporting the book's argument that RTCF is a starting point, not a destination.
